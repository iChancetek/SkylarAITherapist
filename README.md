# Skylar: AI Voice Therapist

Skylar is an emotionally intelligent, voice-interactive Generative AI Therapist designed to offer empathetic mental health support.
...
## Core Features:
- AI-Powered Voice Therapy with Skylar
...
The core AI logic for Skylar's conversations is defined in the Genkit flow at `src/ai/flows/ai-therapy.ts`.
